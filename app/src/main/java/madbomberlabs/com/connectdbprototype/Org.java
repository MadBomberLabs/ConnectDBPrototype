...
public class Org
{
    private String id, org, firstName, lastName, email, phone, website,
    ...
    public Org (String id, String org, String firstName, String lastName, String email, String phone,
                String website, String serviceType, String service, String streetAddress, String city,
                String state, String zip, String favorite)
    {
        this.id = id;
        this.org = org;
